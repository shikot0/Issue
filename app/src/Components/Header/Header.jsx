    ...
    return (
        <header ref={header}>
            <div className="header-content">
                ...
                <>
                    <nav>
                        <Link to="/home" onClick={e => {activeLink(e)}} className='navigation-link' aria-label='Home' title='Home'>
                        ...
                        <Link to={`/issuelist`} onClick={e => {activeLink(e)}} className='navigation-link' aria-label='Issues' title='Issues'>
                        ...
                        <Link to='/registerwebsite' onClick={e => {activeLink(e)}} className='navigation-link' aria-label='Register a new website' title='Register a new website'>
                        ...
                        <Link to={`/user/${user.username}`} onClick={e => {activeLink(e)}} className='navigation-link' aria-label='Account' title='Account'>
                            {user && user._id ? 
