...
import { issueScreenshotRoute, profilePictureRoute, issueRoute } from '../../utils/APIRoutes';
...
function IssuePage() {
    ...
    function toggleTooltip(e, tooltip) {
            ...
            <div className="issue">
                <header>
                    ...
                    <div className="user">
                        ...
                        <Link to={`/user/${issue.openedBy}`} className="issue-creator gradient-text">{issue.openedBy}</Link>
                    </div>
                </header>
                <div className="issue-screenshot-wrapper">
                    <img src={`${issueScreenshotRoute}/${id}`} className="issue-screenshot" alt='issue'/>
                </div>
                <p ref={status} className='issue-status'>Status: <span onClick={handleResolveIssue} className={issue.resolved ? 'resolved' : 'pending'}>{issue.resolved ? 'Resolved' : 'Pending'}</span></p>
                ...
                <div className="tooltip-section">
                    <div ref={tooltip} className="issue-tooltip">
                        ...
                        {issue.openedBy === currentUser.username && !inEditMode ? <button type='button' className='delete-button cta danger' onClick={() => {toggleModal(modal.current)}}>Delete Issue</button> : null}
                    </div>
                    <button type='button' className='open-tooltip-button' onClick={(e) => {toggleTooltip(e,tooltip.current)}}>
