...
function IssuePage() {
    ...
    return(
        ...
        issue && user ?
            ...
            //     {issue && issue.openedBy.username === currentUser.username && inEditMode ?
            ...
            //     {issue.openedBy.username === currentUser.username && !inEditMode ?
            ...
            //     </div>
            // </div>
            // <Issue issue={issue} setEditedValues={setEditedValues} editedValues={editedValues} handleEditIssue={handleEditIssue} deleteIssue={deleteIssue} handleInput={handleInput} handleResolveIssue={handleResolveIssue}/>
            <Issue issue={issue}/>
        : <IssueSkeleton/>
